...
<body>
  ...
  <main class="container">
    ...
    <section id="scanSection" class="card" hidden>
      ...
      <label id="zoomWrap" class="zoomWrap" hidden>
  Zoom
  <input id="zoomSlider" type="range" min="1" max="1" step="0.1" value="1">
      ...
      <div class="row">
        <button id="startScan" class="primary bigPrimary">Start Scanning</button>
        <button id="stopScan" class="ghost" disabled>Stop</button>
        <button id="flashBtn" class="ghost">Light</button>
        <button id="finishedScan" class="secondary">Finished Scanning</button>
